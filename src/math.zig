...
pub fn distancePtSegSqr2D(pt: *const [3]f32, p: *const [3]f32, q: *const [3]f32, t: *f32) f32 {
    ...
    // Recalculate dx, dz with clamped t (distance to segment, not infinite line)
    dx = p[0] + t.* * pqx - pt[0];
    dz = p[2] + t.* * pqz - pt[2];
...
pub inline fn vsub(dest: *[3]f32, v1: *const [3]f32, v2: *const [3]f32) void {
    dest[0] = v1[0] - v2[0];
    dest[1] = v1[1] - v2[1];
    dest[2] = v1[2] - v2[2];
}
...
pub inline fn vadd(dest: *[3]f32, v1: *const [3]f32, v2: *const [3]f32) void {
    dest[0] = v1[0] + v2[0];
    dest[1] = v1[1] + v2[1];
    dest[2] = v1[2] + v2[2];
}
...
pub inline fn vmad(dest: *[3]f32, v1: *const [3]f32, v2: *const [3]f32, s: f32) void {
    dest[0] = v1[0] + v2[0] * s;
    dest[1] = v1[1] + v2[1] * s;
    dest[2] = v1[2] + v2[2] * s;
}
...
pub inline fn vscale(dest: *[3]f32, v: *const [3]f32, s: f32) void {
    dest[0] = v[0] * s;
    dest[1] = v[1] * s;
    dest[2] = v[2] * s;
}
...
pub inline fn vlenSqr(v: *const [3]f32) f32 {
    return v[0] * v[0] + v[1] * v[1] + v[2] * v[2];
}

/// Vector length
pub inline fn vlen(v: *const [3]f32) f32 {
