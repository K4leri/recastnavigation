...
Zig-ядро против [эталонного C++ recastnavigation](https://github.com/K4leri/recastnavigation-bench), замер честный: одинаковые
...
[`docs/perf-audit/`](docs/perf-audit/). Цифры измерены на bench-ветке
